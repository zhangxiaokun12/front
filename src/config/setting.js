...
// 不显示页脚的路由
export const HIDE_FOOTERS = ['/system/dictionary', '/system/organization', '/form/advanced', '/example/choose'];
...
// Ele Pro Guns授权码
export const LICENSE_CODE = 'dk9mcwJyetRWQlxWRiojIzJCLi8mcQ5WaxojI0NWZqJWdiojIklmIsAzMiYXcVV0ZpFVMu9WazJXZ2JCLgICMx4SMiojIQf0NW==';
...
// guns-devops跳转路径
export const GUNS_DEVOPS_URL = 'http://192.168.30.230:8080/guns-devops/tokenLogin?userToken=';
